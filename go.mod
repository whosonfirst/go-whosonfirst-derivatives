...
require (
	...
	github.com/whosonfirst/go-reader-findingaid v0.14.3
	github.com/whosonfirst/go-reader-github v0.6.12
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-findingaid/v2 v2.9.0 // indirect

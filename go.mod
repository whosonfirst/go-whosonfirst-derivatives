...
require (
	...
	github.com/whosonfirst/go-reader-findingaid/v2 v2.0.0
	github.com/whosonfirst/go-reader-github/v2 v2.0.0
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-findingaid/v2 v2.9.2 // indirect
